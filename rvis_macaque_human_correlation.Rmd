...
rvis_macaque<-read.delim("rvis_results_annotated.csv", header=T, sep=",", stringsAsFactors = F)
...
rvis_macaque2<-rvis_macaque[, c(1, 16, 17, 18, 19, 20, 2)]
rvis.macaque.human<-merge(rvis_macaque2, rvis_human, by="hgnc_symbol", all.x=T, all.y=F)
